...
int inquiry_jiu()
{
	...
	{ 
		message_vision("李四瞪眼说到：酒不是已经给你了吗？这位" 
			+ RANK_D->query_respect(me) + "不要贪得无厌。\n", me);
		return 1;
        }
	
        if( !me->query_temp("xkd/backleg") )
	{ 
		message_vision("李四瞪眼说到：这位" + RANK_D->query_respect(me) 
			+ "，你以为这是什么酒，是二锅头啊？？这么宝贵的东西我怎能随便给人呢。\n", me);
		return 1;
        }
...
//	message_vision("李四冷冷地说道：“这位"+ RANK_D->query_respect(me)+"，居然想喝我的毒酒，好吧，你有胆子就喝吧，不过可别后悔。不过看你给我猪腿的份上不想让你年纪轻轻就死。算了，这个拿着！”\n",me);
	message_vision("李四冷冷地说道：这位" + RANK_D->query_respect(me) 
		+ "，居然想喝我的毒酒，好吧，你有胆子就喝吧，不过可别后悔。\n",me);
//好吧，你有胆子就喝吧，不过可别后悔。”。说完，李四从腰间解下一个天蓝色的葫芦，\n
//递了给你。\n" , me);
/*        obn=new("/d/xiakedao/obj/tongpai2");
        obn->set_temp("own",me->query("id"));
        obn->move(me);
        set_temp("野猪/backleg",0);*/

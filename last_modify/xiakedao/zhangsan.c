...
void create()
{
        ...
        set("age", 30);
        set("long",
"只见他身材魁梧，圆脸大耳，穿一袭古铜色绸袍，笑嘻嘻地一脸和蔼可亲。\n");
...
int inquiry_jiu()
{
	...
	{ 
		message_vision("张三笑道：酒不是已经给你了吗？这位" 
			+ RANK_D->query_respect(me) + "不要开我们兄弟的玩笑。\n", me);
		return 1;
        }
	
        if( !me->query_temp("xkd/forleg") )
	{ 
		message_vision("张三笑道：这位" + RANK_D->query_respect(me) 
			+ "，这不是酒。不是我小气，这东西你可喝不得的。\n", me);
		return 1;
        }
...
//	message_vision("张三叹着气说：“这位"+ RANK_D->query_respect(me)+"，你为什么一定要喝这酒呢，这对你可未必有好处。好吧，既然你要，就给个你别的吧。”\n",me);
	message_vision("张三叹着气说：这位" + RANK_D->query_respect(me) 
		+ "，你为什么一定要喝这酒呢，这对你可未必有好处。\n好吧，既然你要，就给你吧，不过你要小心啊！\n",me);
//这酒呢，这对你可未必有好处。好吧，既然你要，就给你吧，不过你要小心啊！”。说完，\n
